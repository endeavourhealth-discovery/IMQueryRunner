...
const selectedProduct: Ref<"QueryRunner"> = ref("QueryRunner");
const productErrorMessage = ref("");
const productOptions = ref(["QueryRunner"]);
watch(selectedProduct, newValue => {
  if (!newValue) productErrorMessage.value = "Required field";
  else productErrorMessage.value = "";
});

const selectedModule: Ref<TaskModule | ""> = ref(TaskModule.QUERY);
...
function setOptions() {
  moduleOptions.value = [TaskModule.QUERY];
